...
import styles from '@/styles/ProjectsMd.module.css';
...
const ProjectsMd = () => {
    ...
    return (
        <div className={styles.projects_wrapper}>
            {/* project 1 */}
            <div className={`${styles.vertical_project_card} ${styles._1}`}>
            ...
            {/* project 2 */}
            <div className={`${styles.vertical_project_card} ${styles._2}`}>
            ...
            <div className={styles.horizontal_project_wrapper}>

                {/* project 3 */}
                <div className={`${styles.horizontal_project_card} ${styles._3}`}>
                ...
                {/* project 4 */}
                <div className={`${styles.horizontal_project_card} ${styles._4}`}>
